...
poisson_blend(mve::FloatImage::ConstPtr src, mve::ByteImage::ConstPtr mask,
    ...
    /* Reformulated system (docs/gpu-accel-texturing.md §21/§22/§38): the
     ...
     * solver that exploits the symmetry this reformulation unlocked, and
     * (unlike the §37 Eigen::NaturalOrdering probe on the old system)
     * its default Eigen::AMDOrdering is a real fill-reducing heuristic,
     * not the identity permutation -- see §38 for the measured
     * comparison. */
    ...
    Eigen::SimplicialLDLT<SpMat, Eigen::Lower, Eigen::AMDOrdering<int> > solver;
    solver.compute(A);
